...
var tile_renderer_scene: PackedScene = preload("res://features/grid/block_renderer.tscn")
var grid_cell_renderer_scene: PackedScene = preload("res://features/grid/grid_cell_renderer.tscn")
var destroy_tile_renderer_particles: PackedScene = preload("res://features/vfx/destroy_particles.tscn")
